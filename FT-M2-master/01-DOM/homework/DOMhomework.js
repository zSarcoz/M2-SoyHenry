...
// toDoItems = toDoItems.map((item)=>{return new ToDo(item.description)
//});
// Sirve para almacenar información en la memoria del NAVEGADOR
...
var name = "Cesar Cottua"

x = document.querySelector('#createdBy')
...
function buildToDos(toDos) {
  ...
  return arr                                   // return toDos.map(buildToDos)  
}
...
//document.querySelector("#ddButton").onclick = addToDo;
//document.querySelector('#toDoInput').addEventListener("keypress",(e)=>{e.key === 'Enter' && addToDo})
